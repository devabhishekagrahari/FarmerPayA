...
const BankCard:React.FC<BankCardProps>=({BankIcon,bankName})=>{
    return (
    <View style={{backgroundColor:'#F8F8F8', borderColor:'#E4E4E4',borderWidth:1,width:(width-56)/2,height:(width-96)/2, borderRadius:16 , justifyContent:'center', alignItems:'center', padding:16, gap:24}}>
          <BankIcon/> 
          <Text style={{fontSize:12, color:'#0000000'}}>{bankName}</Text>
    </View>
    );
}
const selectYourBankScreen = () => {
    ...
    <View style={{flex:1,borderTopStartRadius:32,borderTopEndRadius:32,padding:16,paddingTop:24,gap:16, paddingLeft:24, backgroundColor:'#fff'} }>
        ...
        <View style={{gap:12}}>
            <Text style={{fontSize:20, fontWeight:600 , color:'#1F077A'}}>Popular Banks</Text>
            ...
            <Text style={{fontSize:20, fontWeight:600 ,marginBottom:24, color:'#1F077A'}}>All Banks</Text> 
            <View>
                <View style={{flexDirection:'row', alignItems:'center',gap:12}}><AllahabadIcon/><Text style={{fontSize:16}}>Allahabad Bank</Text></View>
                <View style={{height:1 ,width:width-40,marginTop:16,marginBottom:16, backgroundColor:'#DEDEDE'}}/>

                <View style={{flexDirection:'row', alignItems:'center', gap:12}}><IndianOverSeasIcon/><Text style={{fontSize:16}}>Indian Overseas Bank</Text></View>
                <View style={{height:1 ,width:width-40,marginTop:16,marginBottom:16, backgroundColor:'#DEDEDE'}}/>

                <View style={{flexDirection:'row', alignItems:'center', gap:12}}><CanaraIcon/><Text style={{fontSize:16}}>Canara Bank</Text></View>
                <View style={{height:1 ,width:width-40,marginTop:16,marginBottom:16, backgroundColor:'#DEDEDE'}}/>

                <View style={{flexDirection:'row', alignItems:'center', gap:12}}><BOBIcon/><Text style={{fontSize:16}}>Bank Of Baroda</Text></View>
                <View style={{height:1 ,width:width-40,marginTop:16,marginBottom:16, backgroundColor:'#DEDEDE'}}/>
            </View>
